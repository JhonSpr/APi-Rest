...
// Función para sincronizar los datos locales con Firebase
function sincronizarDatosConFirebase() {
  // Escucha los cambios en la ubicación de los animes en Firebase
  firebaseAnimesRef.once('value', (snapshot) => {
...
// Exporta la función de sincronización para que pueda ser utilizada desde otros archivos
module.exports = sincronizarDatosConFirebase
